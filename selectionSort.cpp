...
int main () {
    ...
    cout << "The running time spent on a random array of size 200 sorted with Selection-Sort algorithm is: " << running_time << " seconds\n\n";
    ...
    running_time = (double)(end_time - start_time) / CLOCKS_PER_SEC; 
    cout << "The running time spent on a random array of size 500 sorted with Selection-Sort algorithm is: " << running_time << " seconds\n\n";
    ...
    running_time = (double)(end_time - start_time) / CLOCKS_PER_SEC; 
    cout << "The running time spent on a random array of size 1000 sorted with Selection-Sort algorithm is: " << running_time << " seconds\n\n";
    ...
    running_time = (double)(end_time - start_time) / CLOCKS_PER_SEC; 
    cout << "The running time spent on a random array of size 5000 sorted with Selection-Sort algorithm is: " << running_time << " seconds\n\n";
    ...
    running_time = (double)(end_time - start_time) / CLOCKS_PER_SEC; 
    cout << "The running time spent on a random array of size 10000 sorted with Selection-Sort algorithm is: " << running_time << " seconds\n\n";
    ...
    running_time = (double)(end_time - start_time) / CLOCKS_PER_SEC; 
    cout << "The running time spent on a random array of size 20000 sorted with Selection-Sort algorithm is: " << running_time << " seconds\n\n";
    ...
    running_time = (double)(end_time - start_time) / CLOCKS_PER_SEC; 
    cout << "The running time spent on a random array of size 50000 sorted with Selection-Sort algorithm is: " << running_time << " seconds\n\n";
    return 0;
}
