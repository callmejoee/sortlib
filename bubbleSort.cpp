...
int main () {
    ...
    cout << "The running time spent on a random array of size 200 sorted with Bubble-Sort algorithm is: " << duration.count () << " microseconds\n\n";
    ...
    cout << "The running time spent on a random array of size 500 sorted with Bubble-Sort algorithm is: " << duration.count () << " microseconds\n\n";
    ...
    duration = duration_cast<microseconds>(end - start);
    cout << "The running time spent on a random array of size 1000 sorted with Bubble-Sort algorithm is: " << duration.count () << " microseconds\n\n";
    ...
    duration = duration_cast<microseconds>(end - start);
    cout << "The running time spent on a random array of size 5000 sorted with Bubble-Sort algorithm is: " << duration.count () << " microseconds\n\n";
    ...
    duration = duration_cast<microseconds>(end - start);
    cout << "The running time spent on a random array of size 10000 sorted with Bubble-Sort algorithm is: " << duration.count () << " microseconds\n\n";
    ...
    duration = duration_cast<microseconds>(end - start);
    cout << "The running time spent on a random array of size 20000 sorted with Bubble-Sort algorithm is: " << duration.count () << " microseconds\n\n"; 
    ...
    duration = duration_cast<microseconds>(end - start);
    cout << "The running time spent on a random array of size 50000 sorted with Bubble-Sort algorithm is: " << duration.count() << " microseconds\n\n";
    return 0;
}